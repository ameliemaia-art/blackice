THREE.BufferGeometryUtils = {
  ...
  computeMorphedAttributes: function (object) {
    ...
    var modifiedPosition = new Float32Array(
      positionAttribute.count * positionAttribute.itemSize
    );
    var modifiedNormal = new Float32Array(
    ...
    var morphedPositionAttribute = new THREE.Float32BufferAttribute(
      modifiedPosition,
      3
    );
    var morphedNormalAttribute = new THREE.Float32BufferAttribute(
      modifiedNormal,
      3
    );
